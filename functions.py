...
from config import ANTENNAS, RFID_IP, SCAN_TIME, WORK_ANT, CONNECT_DATA, NAME, WAIT_TIME
from log import logger

reader = None
FILENAME = "tags"  # файл обменник


def shutdown(factory):
    """Отключение от считывателя"""
    logger.info("ОСТАНАВЛИВАЮ")
    return factory.politeShutdown()


def get_ean13_checksum(tag):
    """Считыем контрольную сумму"""
...
def insert_update_db(zone):
    ...
    try:
        ...
        query = f"INSERT INTO landmark_tag(tag, zone) VALUES('{tag}', '{zone}');"
